import{fh as w,j as e,e as n,dS as C,I as o,dQ as M,m as v,u as m,fi as L,fj as T,fk as D,i as I,fl as S,h as l,fm as W,fn as A,fo as N,fp as $,fq as K,fr as P,fs as E,ft as R,o as p,b3 as z}from"./strapi-DpeDZP07.js";import{W as u}from"./WidgetHelpers-CBlabitx.js";import{g as G,a as H}from"./users-DLc-PG84.js";const Q=l(o)`
  font-size: 2.4rem;
`,V=()=>{const t=w("User",s=>s.user),i=G(t),c=H(t);return e.jsxs(n,{direction:"column",gap:3,height:"100%",justifyContent:"center",children:[e.jsx(C.Item,{delayMs:0,fallback:c}),i&&e.jsx(Q,{fontWeight:"bold",textTransform:"none",textAlign:"center",children:i}),t?.email&&e.jsx(o,{variant:"omega",textColor:"neutral600",children:t?.email}),t?.roles?.length&&e.jsx(n,{marginTop:2,gap:1,wrap:"wrap",children:t?.roles?.map(s=>e.jsx(M,{children:s.name},s.id))})]})},F=l(p)`
  display: grid;
